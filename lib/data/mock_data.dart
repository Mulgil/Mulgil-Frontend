...
abstract final class MockData {
  ...
  static const wrongAnswers = [
    WrongAnswer(courseName: '운영체제', question: '"세마포어는 이진값만 가질 수 있다."', myAnswer: 'X', correct: 'O', isProfEmphasis: true),
    WrongAnswer(courseName: '운영체제', question: '"컨텍스트 스위칭 비용은 무시할 수 있다."', myAnswer: 'O', correct: 'X', isProfEmphasis: false),
    WrongAnswer(courseName: '운영체제', question: '"라운드로빈은 우선순위 기반 스케줄링이다."', myAnswer: 'O', correct: 'X', isProfEmphasis: false),
    WrongAnswer(courseName: '운영체제', question: '실행 시간이 가장 짧은 작업을 우선 처리하는 스케줄링 기법은?', myAnswer: 'FCFS', correct: 'SJF', isProfEmphasis: true),
    WrongAnswer(courseName: '자료구조', question: '"이진 탐색 트리는 항상 균형을 이룬다."', myAnswer: 'O', correct: 'X', isProfEmphasis: true),
    WrongAnswer(courseName: '데이터베이스', question: '"제3정규형을 만족하면 자동으로 BCNF도 만족한다."', myAnswer: 'O', correct: 'X', isProfEmphasis: false),
  ];
  ...
  static final List<Course> courses = [
    ...
    const Course(id: 'c3', name: '데이터베이스', instructor: '박철수 교수님', term: '2026-2'),
  ];

  static final List<TimetableSlot> timetableSlots = [
    const TimetableSlot(id: 't1', courseId: 'c1', weekday: 1, startTime: '09:00', endTime: '10:15'),
    const TimetableSlot(id: 't2', courseId: 'c1', weekday: 4, startTime: '09:00', endTime: '10:15'),
    const TimetableSlot(id: 't3', courseId: 'c2', weekday: 2, startTime: '10:30', endTime: '11:45'),
    const TimetableSlot(id: 't4', courseId: 'c2', weekday: 5, startTime: '10:30', endTime: '11:45'),
    const TimetableSlot(id: 't5', courseId: 'c3', weekday: 3, startTime: '13:00', endTime: '14:15'),
    const TimetableSlot(id: 't6', courseId: 'c3', weekday: 5, startTime: '15:00', endTime: '16:15'),
  ];
